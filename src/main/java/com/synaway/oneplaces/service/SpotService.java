...
/**
 * This service is created for support spots functionality. It's used for
 * manipulations on spot data in application.
 * 
...
public interface SpotService {
    ...
    /**
     * Returns number of spots which are closer than specified distance from
     * point
     * 
     * @param latitude
     * @param longitude
